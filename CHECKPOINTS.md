...
* 6.1) Create a `README.md` file with project description, usage instructions, and design details.✅
    * 6.1.1) Describe the problem and solution.✅
    * 6.1.2) Provide instructions for building and running the program.✅
    * 6.1.3) Document the design choices and synchronization mechanisms.✅
* 6.2) Document the project's architecture and synchronization mechanisms.✅
    * 6.2.1) create a design document, or add to README.md✅
    * 6.2.2) explain synchronization choices made, and their consequences.✅